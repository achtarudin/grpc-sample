...
type HelloServiceClient interface {
	...
	SayHelloToEveryone(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[SayHelloToEveryoneRequest, SayHelloToEveryoneResponse], error)
	SayHelloContinuous(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SayHelloContinuousRequest, SayHelloContinuousResponse], error)
}
...
func (c *helloServiceClient) SayHelloToEveryone(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[SayHelloToEveryoneRequest, SayHelloToEveryoneResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &HelloService_ServiceDesc.Streams[1], HelloService_SayHelloToEveryone_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SayHelloToEveryoneRequest, SayHelloToEveryoneResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type HelloService_SayHelloToEveryoneClient = grpc.ClientStreamingClient[SayHelloToEveryoneRequest, SayHelloToEveryoneResponse]

func (c *helloServiceClient) SayHelloContinuous(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SayHelloContinuousRequest, SayHelloContinuousResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &HelloService_ServiceDesc.Streams[2], HelloService_SayHelloContinuous_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SayHelloContinuousRequest, SayHelloContinuousResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type HelloService_SayHelloContinuousClient = grpc.BidiStreamingClient[SayHelloContinuousRequest, SayHelloContinuousResponse]
...
type HelloServiceServer interface {
	...
	SayHelloToEveryone(grpc.ClientStreamingServer[SayHelloToEveryoneRequest, SayHelloToEveryoneResponse]) error
	SayHelloContinuous(grpc.BidiStreamingServer[SayHelloContinuousRequest, SayHelloContinuousResponse]) error
...
func (UnimplementedHelloServiceServer) SayHelloToEveryone(grpc.ClientStreamingServer[SayHelloToEveryoneRequest, SayHelloToEveryoneResponse]) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloToEveryone not implemented")
}
func (UnimplementedHelloServiceServer) SayHelloContinuous(grpc.BidiStreamingServer[SayHelloContinuousRequest, SayHelloContinuousResponse]) error {
...
func _HelloService_SayHelloToEveryone_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(HelloServiceServer).SayHelloToEveryone(&grpc.GenericServerStream[SayHelloToEveryoneRequest, SayHelloToEveryoneResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type HelloService_SayHelloToEveryoneServer = grpc.ClientStreamingServer[SayHelloToEveryoneRequest, SayHelloToEveryoneResponse]

func _HelloService_SayHelloContinuous_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(HelloServiceServer).SayHelloContinuous(&grpc.GenericServerStream[SayHelloContinuousRequest, SayHelloContinuousResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type HelloService_SayHelloContinuousServer = grpc.BidiStreamingServer[SayHelloContinuousRequest, SayHelloContinuousResponse]
