...
type SayManyHellosRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Name          *SayHelloRequest       `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SayManyHellosRequest) GetName() *SayHelloRequest {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *SayManyHellosResponse) GetMessage() *SayHelloResponse {
	if x != nil {
		return x.Message
	}
	return nil
